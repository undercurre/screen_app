part of 'meiju_login_home_entity.dart';


MeiJuLoginHomeEntity _$MeiJuLoginHomeEntityFromJson(Map<String, dynamic> json) {
	final MeiJuLoginHomeEntity homeEntity = MeiJuLoginHomeEntity();
	...
	final List<RoomEntity>? roomList = meijuJsonConvert.convertListNotNull<RoomEntity>(json['roomList']);
	if (roomList != null) {
...
Map<String, dynamic> _$MeiJuLoginHomeEntityToJson(MeiJuLoginHomeEntity entity) {
