...
class SmallKnobPanelCardWidget extends StatefulWidget {
  ...
  AdapterGenerateFunction<KnobPanelDataAdapter> adapterGenerateFunction;

  SmallKnobPanelCardWidget({
    super.key,
    required this.icon,
  ...
  @override
  _SmallKnobPanelCardWidgetState createState() =>
      _SmallKnobPanelCardWidgetState();
}

class _SmallKnobPanelCardWidgetState extends State<SmallKnobPanelCardWidget> {
  
  late KnobPanelDataAdapter adapter;
  ...
  @override
  void didUpdateWidget(covariant SmallKnobPanelCardWidget oldWidget) {
    if (!widget.disabled) {
