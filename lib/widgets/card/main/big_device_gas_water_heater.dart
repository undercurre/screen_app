...
class BigDeviceGasWaterHeaterWidget extends StatefulWidget {
  ...
  @override
  _BigDeviceGasWaterHeaterWidgetState createState() => _BigDeviceGasWaterHeaterWidgetState();
}

class _BigDeviceGasWaterHeaterWidgetState extends State<BigDeviceGasWaterHeaterWidget> {
              ...
              Positioned(
                ...
                child: GestureDetector(
                  onTap: () {
                    ...
                    Navigator.pushNamed(context, '0xE3', arguments: {"name": widget.name, "adapter": adapter});
                  },
