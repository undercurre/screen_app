...
class mz_slider_noball extends StatefulWidget {
  // 渐变色数组
  ...
  @override
  State<mz_slider_noball> createState() => _MzSliderState();
}

class _MzSliderState extends State<mz_slider_noball> with TickerProviderStateMixin {
  // 轨道的key
  ...
  @override
  void didUpdateWidget(mz_slider_noball oldWidget) {
    if (isPanning) return;
