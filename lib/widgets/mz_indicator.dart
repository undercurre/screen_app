...
class MzIndicator extends StatefulWidget {
  ...
  @override
  State<MzIndicator> createState() => MzIndicatorState();
}

class MzIndicatorState extends State<MzIndicator>
    with TickerProviderStateMixin<MzIndicator> {
  ...
  @override
  void didUpdateWidget(MzIndicator oldWidget) {
