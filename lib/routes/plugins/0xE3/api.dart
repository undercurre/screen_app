...
class WrapGasWaterHeater implements DeviceInterface {
  @override
  Future<Map<String, dynamic>> getDeviceDetail(DeviceEntity deviceInfo) async {
    var res = await WrapGasWaterHeaterApi.getAirConditionDetail(deviceInfo.applianceCode);
    if (res.code == 0) {
      return res.result ?? {};
    } else {
      return {};
  ...
  Future<MzResponseEntity> setPower(DeviceEntity deviceInfo, bool onOff) async {
    return await WrapGasWaterHeaterApi.powerLua(deviceInfo.applianceCode, onOff);
  }
