...
class ElectricWaterHeaterDataEntity {
  ...
  ElectricWaterHeaterDataEntity.fromMeiJu(dynamic data) {
    power = data["power"] == "on";
...
class ElectricWaterHeaterDataAdapter extends DeviceCardDataAdapter<ElectricWaterHeaterDataEntity> {
  String deviceName = "电热水器";
  ...
  ElectricWaterHeaterDataEntity? data = ElectricWaterHeaterDataEntity(
    power: false,
    mode: "",
    temperature: 35,
    endTimeHour : 0,
  ...
  ElectricWaterHeaterDataAdapter(super.platform, this.applianceCode) {
    type = AdapterType.wifiDianre;
  }
  ...
  Future<void> fetchData() async {
    try {
      ...
      if (_meijuData != null) {
        data = ElectricWaterHeaterDataEntity.fromMeiJu(_meijuData!);
      } else if (_homluxData != null) {
        data = ElectricWaterHeaterDataEntity.fromHomlux(_homluxData!);
      } else {
        dataState = DataState.ERROR;
        data = ElectricWaterHeaterDataEntity(
          power: false,
          //开关
          mode: "",
          //模式
  ...
  Future<dynamic> fetchMeijuData() async {
    try {
      var nodeInfo = await MeiJuDeviceApi.getDeviceDetail('0xE2', applianceCode);
