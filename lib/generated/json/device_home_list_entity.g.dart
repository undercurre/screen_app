...
DeviceHomeListEntity $DeviceHomeListEntityFromJson(Map<String, dynamic> json) {
  ...
  final List<DeviceHomeListHomeList>? homeList =
      jsonConvert.convertListNotNull<DeviceHomeListHomeList>(json['homeList']);
  if (homeList != null) {
...
DeviceHomeListHomeList $DeviceHomeListHomeListFromJson(
    Map<String, dynamic> json) {
  final DeviceHomeListHomeList deviceHomeListHomeList =
  ...
  final String? applianceCount =
      jsonConvert.convert<String>(json['applianceCount']);
  ...
  final String? createUserUid =
      jsonConvert.convert<String>(json['createUserUid']);
  ...
  final dynamic? profilePicUrl =
      jsonConvert.convert<dynamic>(json['profilePicUrl']);
  ...
  final List<dynamic>? members =
      jsonConvert.convertListNotNull<dynamic>(json['members']);
  if (members != null) {
  ...
  final dynamic? smartProductId =
      jsonConvert.convert<dynamic>(json['smartProductId']);
  if (smartProductId != null) {
    deviceHomeListHomeList.smartProductId = smartProductId;
  }
  final List<DeviceHomeListHomeListRoomList>? roomList = jsonConvert
      .convertListNotNull<DeviceHomeListHomeListRoomList>(json['roomList']);
  if (roomList != null) {
...
Map<String, dynamic> $DeviceHomeListHomeListToJson(
    DeviceHomeListHomeList entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
...
DeviceHomeListHomeListRoomList $DeviceHomeListHomeListRoomListFromJson(
    Map<String, dynamic> json) {
  final DeviceHomeListHomeListRoomList deviceHomeListHomeListRoomList =
      DeviceHomeListHomeListRoomList();
  final List<DeviceHomeListHomeListRoomListApplianceList>? applianceList =
      jsonConvert.convertListNotNull<
          DeviceHomeListHomeListRoomListApplianceList>(json['applianceList']);
...
Map<String, dynamic> $DeviceHomeListHomeListRoomListToJson(
    DeviceHomeListHomeListRoomList entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
...
DeviceHomeListHomeListRoomListApplianceList
    $DeviceHomeListHomeListRoomListApplianceListFromJson(
        Map<String, dynamic> json) {
  final DeviceHomeListHomeListRoomListApplianceList
      deviceHomeListHomeListRoomListApplianceList =
      DeviceHomeListHomeListRoomListApplianceList();
  final dynamic? templateOfTSL =
      jsonConvert.convert<dynamic>(json['templateOfTSL']);
  if (templateOfTSL != null) {
    deviceHomeListHomeListRoomListApplianceList.templateOfTSL = templateOfTSL;
  }
  final String? isOtherEquipment =
      jsonConvert.convert<String>(json['isOtherEquipment']);
  if (isOtherEquipment != null) {
    deviceHomeListHomeListRoomListApplianceList.isOtherEquipment =
        isOtherEquipment;
  }
  ...
  final String? onlineStatus =
      jsonConvert.convert<String>(json['onlineStatus']);
  ...
  final dynamic? switchStatus =
      jsonConvert.convert<dynamic>(json['switchStatus']);
  ...
  final String? equipmentType =
      jsonConvert.convert<String>(json['equipmentType']);
  ...
  final DeviceHomeListHomeListRoomListApplianceListAbility? ability =
      jsonConvert.convert<DeviceHomeListHomeListRoomListApplianceListAbility>(
          json['ability']);
  if (ability != null) {
  ...
  final dynamic? enterpriseCode =
      jsonConvert.convert<dynamic>(json['enterpriseCode']);
  ...
  final dynamic? nfcLabelInfos =
      jsonConvert.convert<dynamic>(json['nfcLabelInfos']);
  if (nfcLabelInfos != null) {
    deviceHomeListHomeListRoomListApplianceList.nfcLabelInfos = nfcLabelInfos;
  }
  final String? activeStatus =
      jsonConvert.convert<String>(json['activeStatus']);
  ...
  final String? isSupportFetchStatus =
      jsonConvert.convert<String>(json['isSupportFetchStatus']);
  if (isSupportFetchStatus != null) {
    deviceHomeListHomeListRoomListApplianceList.isSupportFetchStatus =
        isSupportFetchStatus;
  }
  ...
  final dynamic? nameChanged =
      jsonConvert.convert<dynamic>(json['nameChanged']);
  if (nameChanged != null) {
  ...
  if (detail != null) {
    deviceHomeListHomeListRoomListApplianceList.detail = detail;
  }
  return deviceHomeListHomeListRoomListApplianceList;
}

Map<String, dynamic> $DeviceHomeListHomeListRoomListApplianceListToJson(
    DeviceHomeListHomeListRoomListApplianceList entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
...
DeviceHomeListHomeListRoomListApplianceListAbility
    $DeviceHomeListHomeListRoomListApplianceListAbilityFromJson(
        Map<String, dynamic> json) {
  final DeviceHomeListHomeListRoomListApplianceListAbility
      deviceHomeListHomeListRoomListApplianceListAbility =
      DeviceHomeListHomeListRoomListApplianceListAbility();
  final int? bleAppBindStatus =
      jsonConvert.convert<int>(json['bleAppBindStatus']);
  if (bleAppBindStatus != null) {
    deviceHomeListHomeListRoomListApplianceListAbility.bleAppBindStatus =
        bleAppBindStatus;
  }
  final int? supportGateway = jsonConvert.convert<int>(json['supportGateway']);
  if (supportGateway != null) {
    deviceHomeListHomeListRoomListApplianceListAbility.supportGateway =
        supportGateway;
  }
  ...
  if (supportBleMesh != null) {
    deviceHomeListHomeListRoomListApplianceListAbility.supportBleMesh =
        supportBleMesh;
  }
  ...
  if (supportADNS != null) {
    deviceHomeListHomeListRoomListApplianceListAbility.supportADNS =
        supportADNS;
  }
  final int? supportBleDataTransfers =
      jsonConvert.convert<int>(json['supportBleDataTransfers']);
  if (supportBleDataTransfers != null) {
    deviceHomeListHomeListRoomListApplianceListAbility.supportBleDataTransfers =
        supportBleDataTransfers;
  }
  final int? supportBindStatus =
      jsonConvert.convert<int>(json['supportBindStatus']);
  if (supportBindStatus != null) {
    deviceHomeListHomeListRoomListApplianceListAbility.supportBindStatus =
        supportBindStatus;
  }
  final int? supportOfflineMsg =
      jsonConvert.convert<int>(json['supportOfflineMsg']);
  if (supportOfflineMsg != null) {
    deviceHomeListHomeListRoomListApplianceListAbility.supportOfflineMsg =
        supportOfflineMsg;
  }
  final int? bleDeviceStatus =
      jsonConvert.convert<int>(json['bleDeviceStatus']);
  if (bleDeviceStatus != null) {
    deviceHomeListHomeListRoomListApplianceListAbility.bleDeviceStatus =
        bleDeviceStatus;
  }
  final int? supportNewKeyVersion =
      jsonConvert.convert<int>(json['supportNewKeyVersion']);
  if (supportNewKeyVersion != null) {
    deviceHomeListHomeListRoomListApplianceListAbility.supportNewKeyVersion =
        supportNewKeyVersion;
  }
  final int? domainSwitch = jsonConvert.convert<int>(json['domainSwitch']);
  if (domainSwitch != null) {
    deviceHomeListHomeListRoomListApplianceListAbility.domainSwitch =
        domainSwitch;
  }
  final int? supportBindCode =
      jsonConvert.convert<int>(json['supportBindCode']);
  if (supportBindCode != null) {
    deviceHomeListHomeListRoomListApplianceListAbility.supportBindCode =
        supportBindCode;
  }
  final int? supportBleOta = jsonConvert.convert<int>(json['supportBleOta']);
  if (supportBleOta != null) {
    deviceHomeListHomeListRoomListApplianceListAbility.supportBleOta =
        supportBleOta;
  }
  final int? supportReset = jsonConvert.convert<int>(json['supportReset']);
  if (supportReset != null) {
    deviceHomeListHomeListRoomListApplianceListAbility.supportReset =
        supportReset;
  }
  final int? supportRouterReportAndQuery =
      jsonConvert.convert<int>(json['supportRouterReportAndQuery']);
  if (supportRouterReportAndQuery != null) {
    deviceHomeListHomeListRoomListApplianceListAbility
        .supportRouterReportAndQuery = supportRouterReportAndQuery;
  }
  final String? isBluetoothControl =
      jsonConvert.convert<String>(json['isBluetoothControl']);
  if (isBluetoothControl != null) {
    deviceHomeListHomeListRoomListApplianceListAbility.isBluetoothControl =
        isBluetoothControl;
  }
  final String? distributionNetworkType =
      jsonConvert.convert<String>(json['distributionNetworkType']);
  if (distributionNetworkType != null) {
    deviceHomeListHomeListRoomListApplianceListAbility.distributionNetworkType =
        distributionNetworkType;
  }
  final int? supportMedia = jsonConvert.convert<int>(json['supportMedia']);
  if (supportMedia != null) {
    deviceHomeListHomeListRoomListApplianceListAbility.supportMedia =
        supportMedia;
  }
  final int? supportFindFriends =
      jsonConvert.convert<int>(json['supportFindFriends']);
  if (supportFindFriends != null) {
    deviceHomeListHomeListRoomListApplianceListAbility.supportFindFriends =
        supportFindFriends;
  }
  final int? supportDiagnosis =
      jsonConvert.convert<int>(json['supportDiagnosis']);
  if (supportDiagnosis != null) {
    deviceHomeListHomeListRoomListApplianceListAbility.supportDiagnosis =
        supportDiagnosis;
  }
  final int? supportQueryToken =
      jsonConvert.convert<int>(json['supportQueryToken']);
  if (supportQueryToken != null) {
    deviceHomeListHomeListRoomListApplianceListAbility.supportQueryToken =
        supportQueryToken;
  }
  final int? supportNetworkBridge =
      jsonConvert.convert<int>(json['supportNetworkBridge']);
  if (supportNetworkBridge != null) {
    deviceHomeListHomeListRoomListApplianceListAbility.supportNetworkBridge =
        supportNetworkBridge;
  }
  return deviceHomeListHomeListRoomListApplianceListAbility;
}

Map<String, dynamic> $DeviceHomeListHomeListRoomListApplianceListAbilityToJson(
    DeviceHomeListHomeListRoomListApplianceListAbility entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
