...
Weather7dEntity $Weather7dEntityFromJson(Map<String, dynamic> json) {
  final Weather7dEntity weather7dEntity = Weather7dEntity();
  final String? date = jsonConvert.convert<String>(json['date']);
  if (date != null) {
    weather7dEntity.date = date;
  }
  final String? dayWeatherStatus =
      jsonConvert.convert<String>(json['dayWeatherStatus']);
  ...
  final String? nightWeatherStatus =
      jsonConvert.convert<String>(json['nightWeatherStatus']);
  if (nightWeatherStatus != null) {
    weather7dEntity.nightWeatherStatus = nightWeatherStatus;
  }
  final String? nightLowGrade =
      jsonConvert.convert<String>(json['nightLowGrade']);
  if (nightLowGrade != null) {
    weather7dEntity.nightLowGrade = nightLowGrade;
  }
  final String? nightWindForce =
      jsonConvert.convert<String>(json['nightWindForce']);
  if (nightWindForce != null) {
    weather7dEntity.nightWindForce = nightWindForce;
  }
  final String? dayHighGrade =
      jsonConvert.convert<String>(json['dayHighGrade']);
...
Map<String, dynamic> $Weather7dEntityToJson(Weather7dEntity entity) {
