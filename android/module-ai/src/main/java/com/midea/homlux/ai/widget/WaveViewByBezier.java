package com.midea.homlux.ai.widget;
...
public class WaveViewByBezier extends View {
    private static final String TAG = WaveViewByBezier.class.getSimpleName();
    ...
    private int[] COLORS = {0xFF7a00b2, 0xFF0000ff, 0xFF768cff};
